...
const atomic = new LinksGenerator('mrkeksztests', '5KeXV9k5izST6teiGNidSqkMBk11uztTKvb77SuZLbucJhJGMBq', true, true)
let links = []
...
$buttonGenerate.onclick = async () => {
    ...
    try {
        const assetPages = await atomic.getAssetIDs(name, undefined, 2)
...
async function downloadExcel() {
    ...
    // return await workbook.csv.writeFile("claimlinks.xlsx")
